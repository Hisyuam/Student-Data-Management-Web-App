...
<?php
  ...
  // Cek apakah ada GET ubah (edit)
  if (isset($_GET['ubah'])) {
    $mahasiswa_id = $_GET['ubah'];

    // Cek apakah data mahasiswa ini milik user yang login
    $queryCheck = "SELECT * FROM mahasiswa WHERE mahasiswa_id = '$mahasiswa_id' AND mahasiswa_id = '$mahasiswaId'";
        ...
        <div class="mb-3 row mt-3">
          <div class="col-sm-10">
            <?php if(isset($_GET['ubah'])): ?>
              <button href="main.php" type="submit" name="aksi" value="edit" class="btn btn-primary">Simpan Perubahan</button>
            <?php else: ?>
              <button href="main.php" type="submit" name="aksi" value="add" class="btn btn-primary">Tambahkan</button>
            <?php endif; ?>
            <a href="main.php" type="button" class="btn btn-danger">Batal</a>
          </div>
        </div>
